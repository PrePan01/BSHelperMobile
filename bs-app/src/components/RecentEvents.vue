...
import calModeNum from "@/utils/calModeNum";
import calBrawlersUse from "@/utils/calBrawlersUse";
...
export default {
  ...
  mounted() {
    ...
    this.$bus.$on('BattleLogs', (data) => {
      ...
      this.summary()
      let brawlersUse = calBrawlersUse(this.battleLogs, this.myName)
      this.brawlUse = brawlersUse[0]
      this.brawlUseSorted = brawlersUse[1]
      this.modeNum = calModeNum(this.battleLogs)
      this.drawChart()
    })
